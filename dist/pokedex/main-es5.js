...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_pokemon_pokemon_list_pokemon_list_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ./components/pokemon/pokemon-list/pokemon-list.component */
    "./src/app/components/pokemon/pokemon-list/pokemon-list.component.ts");
    /* harmony import */


    var _components_pokemon_pokemon_details_pokemon_details_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./components/pokemon/pokemon-details/pokemon-details.component */
    "./src/app/components/pokemon/pokemon-details/pokemon-details.component.ts");

    var routes = [{
      path: '',
      component: _components_pokemon_pokemon_list_pokemon_list_component__WEBPACK_IMPORTED_MODULE_2__["PokemonListComponent"],
      pathMatch: 'full'
    }, {
      path: 'pokemon',
      component: _components_pokemon_pokemon_list_pokemon_list_component__WEBPACK_IMPORTED_MODULE_2__["PokemonListComponent"]
      ...
      path: 'detail/:id',
      component: _components_pokemon_pokemon_details_pokemon_details_component__WEBPACK_IMPORTED_MODULE_3__["PokemonDetailsComponent"]
    }, {
      path: '**',
      redirectTo: ''
    }];
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_pokemon_pokemon_list_pokemon_list_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./components/pokemon/pokemon-list/pokemon-list.component */
    "./src/app/components/pokemon/pokemon-list/pokemon-list.component.ts");
    /* harmony import */


    var _components_pokemon_pokemon_details_pokemon_details_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./components/pokemon/pokemon-details/pokemon-details.component */
    "./src/app/components/pokemon/pokemon-details/pokemon-details.component.ts");
    /* harmony import */


    var _shared_pipes_search_pipe__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
    ...
    AppModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      ...
      providers: [],
      imports: [[_angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"]]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, {
        declarations: [_shared_pipes_search_pipe__WEBPACK_IMPORTED_MODULE_7__["SearchPipe"], _app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _components_pokemon_pokemon_list_pokemon_list_component__WEBPACK_IMPORTED_MODULE_5__["PokemonListComponent"], _components_pokemon_pokemon_details_pokemon_details_component__WEBPACK_IMPORTED_MODULE_6__["PokemonDetailsComponent"]],
        imports: [_angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormsModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"]]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function srcAppComponentsPokemonPokemonDetailsPokemonDetailsComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function PokemonDetailsComponent_div_0_ul_19_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function PokemonDetailsComponent_div_0_ul_22_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ul");
      ...
      if (rf & 2) {
        var pokeAbilities_r5 = ctx.$implicit;
    ...
    function PokemonDetailsComponent_div_0_ul_37_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "ul");
    ...
    function PokemonDetailsComponent_div_0_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](25, "Caracter\xEDsticas");
    ...
    var PokemonDetailsComponent = /*#__PURE__*/function () {
      function PokemonDetailsComponent(pokemonService, route) {
      ...
      _createClass(PokemonDetailsComponent, [{
        ...
        key: "getPokemonId",
        value: function getPokemonId() {
          var _this = this;

          this.sub = this.route.params.subscribe(function (params) {
            _this.pokemonService.getPokemonId(params.id).subscribe(function (data) {
              _this.pokemon = data;
    ...
    PokemonDetailsComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 1,
      vars: 1,
      consts: [["class", "container", 4, "ngIf"], [1, "container"], [1, "my-4"], [1, "row"], [1, "col-md-3", "col-sm-6", "mb-4"], ["width", "100", 3, "src"], [1, "col-md-4"], [1, "my-3"], [4, "ngFor", "ngForOf"]],
      ...
      pipes: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["TitleCasePipe"], _angular_common__WEBPACK_IMPORTED_MODULE_3__["SlicePipe"]],
  ...
  /***/
  function srcAppComponentsPokemonPokemonListPokemonListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var _shared_pipes_search_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ../../../shared/pipes/search.pipe */
    "./src/app/shared/pipes/search.pipe.ts");
    ...
    function PokemonListComponent_li_8_Template(rf, ctx) {
      if (rf & 1) {
    ...
    var PokemonListComponent = /*#__PURE__*/function () {
      ...
      _createClass(PokemonListComponent, [{
        ...
        value: function getAll() {
          ...
          this.pokemonService.getPokemon(this.offset, this.limit).subscribe(function (data) {
            _this2.pokemons = data;
            Object.keys(_this2.pokemons.results).map(function (key) {
              _this2.showPokemon(_this2.pokemons.results[key].name);
            });
          });
        }
      }, {
        key: "showPokemon",
        value: function showPokemon(id) {
          var _this3 = this;

          this.pokemonService.getPokemonId(id).subscribe(function (data) {
            var newPokemon = {
              id: data.id,
              name: data.name,
            ...
            _this3.pokemon.push(newPokemon);

            _this3.pokemon.sort(function (array, order) {
    ...
    PokemonListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 13,
      vars: 5,
      consts: [[1, "our-webcoderskull", "padding-lg"], [1, "container"], [1, "col-md-4"], ["type", "text", 1, "form-control", 3, "ngModel", "ngModelChange"], [1, "row"], ["class", "col-12 col-md-6 col-lg-3", 4, "ngFor", "ngForOf"], [1, "container-button"], [1, "button-style", 3, "click"], [1, "col-12", "col-md-6", "col-lg-3"], [1, "cnt-block", "equal-hight", 2, "height", "349px", 3, "routerLink"], ["alt", "pokeimage", 1, "img-responsive", 3, "src"]],
      template: function PokemonListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function PokemonListComponent_Template_input_ngModelChange_5_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function PokemonListComponent_Template_button_click_11_listener() {
            return ctx.onSubmit();
          });
  ...
  function srcAppServicesPokemonServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var PokemonService = /*#__PURE__*/function () {
      ...
      _createClass(PokemonService, [{
        key: "getPokemon",
        value: function getPokemon(id, limit) {
          return this.http.get("".concat(this.Url, "?offset=").concat(id, "&limit=").concat(limit));
        }
      }, {
        key: "getPokemonId",
        value: function getPokemonId(id) {
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\HommyDeJesus\Documents\Projects\pokedex\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
